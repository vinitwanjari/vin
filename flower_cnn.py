# -*- coding: utf-8 -*-
"""
Created on Sat Jan  7 jan 2019

@author: vinit wanjari
"""
...
daisy=glob.glob(os.path.join(data_dir,'daisy/*.jpg'))
dandelion=glob.glob(os.path.join(data_dir,'dandelion/*.jpg'))
rose=glob.glob(os.path.join(data_dir,'rose/*.jpg'))
sunflower=glob.glob(os.path.join(data_dir,'sunflower/*.jpg'))
tulip=glob.glob(os.path.join(data_dir,'tulip/*.jpg'))
